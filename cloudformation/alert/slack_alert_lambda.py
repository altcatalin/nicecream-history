...
def lambda_handler(event, context):
    ...
    channel_map = json.loads(os.getenv('CHANNEL_MAP'))
    ...
    req = urllib.request.Request(webhook_url, data=json.dumps(payload).encode('utf8'), headers={'Content-Type': 'application/json'})
